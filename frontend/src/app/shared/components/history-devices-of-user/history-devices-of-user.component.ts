...
@Component({
  selector: 'app-history-devices-of-user',
  templateUrl: './history-devices-of-user.component.html',
  styleUrls: ['./history-devices-of-user.component.css']
})
export class HistoryDevicesOfUserComponent implements OnInit {
  ...
  loadData(): void {
    this.userService.getHistoryDevices(this.pageable).subscribe(
      (data) => {
